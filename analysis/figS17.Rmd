...
ggplot(f,aes(x=type,y=c,color=type))+geom_boxplot(outlier.shape=NA)+geom_jitter()+theme_classic()+xlab("")+ylab("Spearman Correlation Coefficient Between Replicates")+labs(color="")+scale_color_manual(values=c("deeppink4","black"))
